...
<p>L'inventaire complet est dans <a target="_blank" rel="noopener noreferrer" href="/posts/ten-years-of-home-automation">l'épisode précédent</a> : 87 appareils, 929 entités, 43 intégrations. Un seul chiffre compte ici. Matter devait être le standard qui range tout ça, et chez moi il pilote neuf appareils sur quatre-vingt-sept. Le reste est une longue traîne d'exceptions qui ne disparaîtra jamais : un pont Somfy qui ne parle que HomeKit, une télécommande infrarouge pour la porte de l'atelier, huit ampoules Wi-Fi d'un constructeur chinois, des caméras en <abbr title="Standard ouvert d'interface pour caméras IP">ONVIF</abbr>.</p>
...
<p><strong>Un modèle solaire par façade.</strong> Chaque volet décide seul, à partir de la température de sa pièce et de la position du soleil sur sa façade. Les orientations ne viennent pas d'une boussole mais du cadastre, recoupé avec trente jours de corrélation entre température et <abbr title="Direction du soleil sur l'horizon, en degrés depuis le nord">azimut</abbr> solaire. Le bureau a même son masque d'horizon : le soleil n'entre réellement qu'à quatorze degrés d'élévation, cinquante minutes après le lever.</p>
<p><strong>Le bureau invivable.</strong> La bonne question n'était pas « comment le refroidir » mais « d'où vient la chaleur ». Home Assistant avait déjà les deux séries nécessaires : la température de la pièce minute par minute, et la consommation de la baie informatique sur une prise mesurée depuis 2024. Il suffisait de les superposer, ce qui a pris le temps de formuler la demande. La baie tire 312 W à l'instant où j'écris, et 8 kWh sur la journée d'hier, soit une moyenne de 335 W qui ne s'arrête jamais. Sur les sept derniers jours, le bureau est à 26,8 °C de moyenne entre une heure et six heures du matin, contre 24,6 au salon et 17,5 dehors. Le volet n'a jamais été le levier.</p>
...
<p><strong>The unlivable office.</strong> The right question was not "how do I cool it" but "where is the heat coming from". Home Assistant already held both series: the room's temperature minute by minute, and the server rack's consumption on a metered socket since 2024. Overlaying them took as long as phrasing the request. The rack draws 312 W as I write, and 8 kWh across yesterday, an average of 335 W that never stops. Over the last seven days the office averages 26.8 °C between one and six in the morning, against 24.6 in the living room and 17.5 outside. The shutter was never the lever.</p>
