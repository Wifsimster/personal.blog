...
<video class="post-video video-light" poster="/visuals/cost-of-trying/coupure-tv-fr-light.jpg" autoplay muted loop playsinline preload="metadata" aria-label="Animation en trois temps. À 19 h 30, la routine coupe la prise TV ; dix secondes plus tard, un garde-fou sans condition la rallume. Le journal désigne ce garde-fou et l'agent lui ajoute une condition. Le soir suivant, la coupure tient."><source media="(max-width: 640px)" src="/visuals/cost-of-trying/coupure-tv-fr-light-tall.webm" type="video/webm"><source media="(max-width: 640px)" src="/visuals/cost-of-trying/coupure-tv-fr-light-tall.mp4" type="video/mp4"><source src="/visuals/cost-of-trying/coupure-tv-fr-light.webm" type="video/webm"><source src="/visuals/cost-of-trying/coupure-tv-fr-light.mp4" type="video/mp4"></video>
<video class="post-video video-dark" poster="/visuals/cost-of-trying/coupure-tv-fr-dark.jpg" autoplay muted loop playsinline preload="metadata" aria-label="Animation en trois temps. À 19 h 30, la routine coupe la prise TV ; dix secondes plus tard, un garde-fou sans condition la rallume. Le journal désigne ce garde-fou et l'agent lui ajoute une condition. Le soir suivant, la coupure tient."><source media="(max-width: 640px)" src="/visuals/cost-of-trying/coupure-tv-fr-dark-tall.webm" type="video/webm"><source media="(max-width: 640px)" src="/visuals/cost-of-trying/coupure-tv-fr-dark-tall.mp4" type="video/mp4"><source src="/visuals/cost-of-trying/coupure-tv-fr-dark.webm" type="video/webm"><source src="/visuals/cost-of-trying/coupure-tv-fr-dark.mp4" type="video/mp4"></video>
...
<video class="post-video video-light" poster="/visuals/cost-of-trying/coupure-tv-en-light.jpg" autoplay muted loop playsinline preload="metadata" aria-label="Three-step animation. At 7:30 p.m. the routine cuts the TV plug; ten seconds later a guard with no conditions switches it back on. The logbook names that guard and the agent adds a condition to it. The next evening, the cut holds."><source media="(max-width: 640px)" src="/visuals/cost-of-trying/coupure-tv-en-light-tall.webm" type="video/webm"><source media="(max-width: 640px)" src="/visuals/cost-of-trying/coupure-tv-en-light-tall.mp4" type="video/mp4"><source src="/visuals/cost-of-trying/coupure-tv-en-light.webm" type="video/webm"><source src="/visuals/cost-of-trying/coupure-tv-en-light.mp4" type="video/mp4"></video>
<video class="post-video video-dark" poster="/visuals/cost-of-trying/coupure-tv-en-dark.jpg" autoplay muted loop playsinline preload="metadata" aria-label="Three-step animation. At 7:30 p.m. the routine cuts the TV plug; ten seconds later a guard with no conditions switches it back on. The logbook names that guard and the agent adds a condition to it. The next evening, the cut holds."><source media="(max-width: 640px)" src="/visuals/cost-of-trying/coupure-tv-en-dark-tall.webm" type="video/webm"><source media="(max-width: 640px)" src="/visuals/cost-of-trying/coupure-tv-en-dark-tall.mp4" type="video/mp4"><source src="/visuals/cost-of-trying/coupure-tv-en-dark.webm" type="video/webm"><source src="/visuals/cost-of-trying/coupure-tv-en-dark.mp4" type="video/mp4"></video>
