...
<p><strong>Un modèle solaire par façade.</strong> Chaque volet décide seul, à partir de la température de sa pièce et de la position du soleil sur sa façade. Les orientations viennent du cadastre, recoupé avec trente jours de corrélation entre température et <abbr title="Direction du soleil sur l'horizon, en degrés depuis le nord">azimut</abbr> solaire. Le bureau a même son masque d'horizon : le soleil n'entre réellement qu'à quatorze degrés d'élévation, cinquante minutes après le lever.</p>
<p><strong>Le bureau invivable.</strong> J'ai d'abord cherché comment le refroidir. La question utile était d'où venait la chaleur. Home Assistant avait déjà les deux séries nécessaires : la température de la pièce minute par minute, et la consommation de la baie informatique sur une prise mesurée depuis 2024. Il suffisait de les superposer, ce qui a pris le temps de formuler la demande. La baie tire 312 W à l'instant où j'écris, et 8 kWh sur la journée d'hier, soit une moyenne de 335 W qui ne s'arrête jamais. Sur les sept derniers jours, le bureau est à 26,8 °C de moyenne entre une heure et six heures du matin, contre 24,6 au salon et 17,5 dehors. Aucun volet n'allait régler ça.</p>
<p><strong>Le ventilateur de plafond.</strong> De ce diagnostic est sortie une régulation que je n'avais pas prévue en commençant. Un barème traduit la température du bureau en une vitesse de 0 à 6 : rien en dessous de 25 °C, vitesse 1 à partir de 25, 2 à 26,5, puis un cran tous les degrés et demi jusqu'à 6 au-delà de 32,5. La commande part en infrarouge, par la même télécommande que la porte de l'atelier. Elle n'est active que de mai à septembre et se coupe d'un interrupteur. À l'instant où j'écris : 26,6 °C dans la pièce, vitesse 2.</p>
<p><strong>Le tableau électrique.</strong> Même méthode, même surprise. Le compteur général publie la puissance, l'intensité et le facteur de puissance des trois phases, et l'historique garde tout. Une première analyse en puissance désignait la phase A comme la plus chargée, à 96 % de sa capacité horaire. Relue en ampères sur trente jours, elle est la plus libre. A plafonne à 13,5 A quand B monte à 26,7 A. Les pointes de B sont plus brèves et passaient sous le radar d'un maximum horaire. La bonne phase où ajouter une charge était exactement celle qu'il fallait soulager selon le premier calcul.</p>
...
<p><strong>Observer.</strong> J'ai annoncé une chambre orientée sud-sud-est. Le calcul qui en découlait laissait le volet ouvert toute la matinée alors que la pièce était en plein soleil. Il a fallu regarder la pièce pour voir l'erreur.</p>
...
<p><strong>Lire la série :</strong> <a target="_blank" rel="noopener noreferrer" href="/posts/ten-years-of-home-automation">Dix ans de domotique tout seul, un an avec un agent</a> — l'inventaire de l'installation, dix ans d'empilement, et la mesure de ce qui a changé. <a target="_blank" rel="noopener noreferrer" href="/posts/daily-rhythm">J'ai changé le calendrier du soir trois fois en une semaine</a> — la maison qui porte le rythme de la journée. <a target="_blank" rel="noopener noreferrer" href="/posts/not-the-sun">Mon bureau est à 29 °C la nuit</a> — six volets qui décident seuls, et ce que le modèle m'a dit de ne pas faire.</p>`
}
...
<p><strong>A per-facade solar model.</strong> Each shutter decides on its own, from its room temperature and the sun's position on its facade. The orientations come from the land registry, cross-checked against thirty days of correlation between temperature and solar <abbr title="The sun's compass direction, in degrees from north">azimuth</abbr>. The office even has a horizon mask: sunlight only really enters at fourteen degrees of elevation, fifty minutes after sunrise.</p>
<p><strong>The unlivable office.</strong> I first asked how to cool it. The useful question was where the heat came from. Home Assistant already held both series: the room's temperature minute by minute, and the server rack's consumption on a metered socket since 2024. Overlaying them took as long as phrasing the request. The rack draws 312 W as I write, and 8 kWh across yesterday, an average of 335 W that never stops. Over the last seven days the office averages 26.8 °C between one and six in the morning, against 24.6 in the living room and 17.5 outside. No shutter was going to fix that.</p>
<p><strong>The ceiling fan.</strong> That diagnosis produced a regulation I had not planned on. A scale turns the office temperature into a speed from 0 to 6: nothing below 25 °C, speed 1 from 25, 2 at 26.5, then a notch every degree and a half up to 6 past 32.5. The command goes out over infrared, through the same remote as the workshop door. It only runs from May to September and switches off from a single toggle. As I write: 26.6 °C in the room, speed 2.</p>
<p><strong>The electrical panel.</strong> Same method, same surprise. The main meter publishes power, current and power factor for all three phases, and the history keeps everything. A first pass in watts flagged phase A as the most loaded, at 96% of its hourly capacity. Re-read in amps over thirty days it is the freest of the three. A peaks at 13.5 A while B reaches 26.7 A. B's peaks are shorter and slipped under an hourly maximum. The right phase to add load to was precisely the one the first calculation told me to relieve.</p>
...
<p><strong>Observing.</strong> I described a bedroom as facing south-south-east. The maths that followed left the shutter open all morning while the room sat in full sun. It took looking at the room to catch the error.</p>
