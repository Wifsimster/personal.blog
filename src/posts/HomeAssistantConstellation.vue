...
<p>I used to think the expensive part of home automation was writing the <abbr title="A readable configuration file format, used by Home Assistant">YAML</abbr>. In six months I have barely written any, and the time went somewhere else: recovering context. Which automations touch this entity. Which of my three day-lists has to stay in sync with the other two. Which guard, written eight months ago, is about to overwrite the command I just sent.</p>
