...
<hr>
<p>Depuis mars, mon équipe construit Solstice, une plateforme greenfield partie d'une page blanche. En quatre mois, on a moins écrit du code qu'on n'a réécrit notre façon d'en produire : un cadrage par service, des agents qui tiennent chacun leur périmètre, une porte de vérification qui rend son verdict avant qu'un humain ne lise le diff. C'est cette méthode que je viens raconter — comment elle s'est mise en place, et ce qu'elle a produit.</p>
...
<blockquote><p>« L'autonomie ne se décrète pas au niveau du modèle. Elle s'équipe, périmètre par périmètre — un cadrage, des skills, une porte qui sait dire non. »</p></blockquote>
