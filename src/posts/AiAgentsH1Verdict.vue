...
<p>A postscript I had not planned when I started: the method described above doesn't just speed up one team. It gets noticed, it attracts, and it ends up flowing back as policy — the local learning loop becomes the wider strategy. It is not yet the value proof I keep asking for in this series, but when a way of working starts getting held up as the example well beyond the team that invented it, that pull is a measurement too.</p>
...
<p>Un post-scriptum que je n'avais pas prévu en commençant : la méthode décrite plus haut ne fait pas qu'accélérer une équipe. Elle se remarque, elle attire, et elle finit par redescendre en politique — la boucle d'apprentissage locale devient la stratégie plus large. Ce n'est pas encore la preuve de valeur que je réclame dans cette série, mais quand une façon de travailler commence à être citée en exemple bien au-delà de l'équipe qui l'a inventée, cette attraction est aussi une mesure.</p>
