...
<p>Six months ago, I was making predictions from inside that team, with almost nothing external to back them. Now the studies are out, and they back the calls. Let's take it in order.</p>
...
<tr><td><strong>AI is an amplifier</strong></td><td>Confirmed</td><td>Throughput up top, quality costs compounding below. <abbr title="Massachusetts Institute of Technology">MIT</abbr> found 95% of <abbr title="Generative AI">GenAI</abbr> pilots delivered no measurable <abbr title="Profit and Loss">P&amp;L</abbr> impact. The tool amplifies the system around it — exactly the claim, and the reading <a target="_blank" rel="noopener noreferrer" href="/posts/dora-ai-roi-report">my DORA piece</a> laid out.</td></tr>
...
<p><strong>Read the rest of the series:</strong> <a target="_blank" rel="noopener noreferrer" href="/posts/sdlc-is-dead">The SDLC Is Dead</a> — why the process was always waste. <a target="_blank" rel="noopener noreferrer" href="/posts/coder-is-dead-engineer-is-born">Coding Was Never the Job</a> — what the engineer becomes when the syntax disappears. <a target="_blank" rel="noopener noreferrer" href="/posts/ai-team-reflex">AI Became a Team Reflex</a> — what an AI-native team looks like on a Tuesday. <a target="_blank" rel="noopener noreferrer" href="/posts/dora-ai-roi-report">DORA Just Confirmed What My Team Already Lived</a> — the report that put external data behind what we were already living.</p>
<hr>
<h2>Sources</h2>
<ul>
...
<p>Il y a six mois, j'écrivais des prédictions depuis l'intérieur de cette équipe, sans presque rien d'externe pour les appuyer. Aujourd'hui, les études sont sorties, et elles confirment les paris. Reprenons dans l'ordre.</p>
