...
<p>Le plus long a été de choisir l'académie. Trouver le bon jeu de données dans le catalogue de l'État, comprendre la syntaxe de son filtre et écrire les deux capteurs n'a pas pris beaucoup plus de temps que de le décrire ici.</p>
...
<p>The longest part was picking the right académie. Finding the dataset in the state catalogue, working out its filter syntax and writing the two sensors took barely longer than describing it here.</p>
...
<p><strong>Read the series:</strong> <a target="_blank" rel="noopener noreferrer" href="/posts/ten-years-of-home-automation">Ten Years of Home Automation Alone. One Year With an Agent</a> — the inventory and a measurement of what changed. <a target="_blank" rel="noopener noreferrer" href="/posts/cost-of-trying">AI Didn't Automate My House</a> — why the win shows up on the projects you never started. <a target="_blank" rel="noopener noreferrer" href="/posts/not-the-sun">My Office Sits at 29 °C at Night</a> — six shutters deciding on their own, and what the model told me not to do.</p>`
}
