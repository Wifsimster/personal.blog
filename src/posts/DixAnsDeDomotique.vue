...
const frenchContent: PostContent = {
  ...
  html: `<div class="post-tldr"><p><strong>TL;DR</strong> Mon dernier billet de domotique date d'avril 2016 : un capteur de luminosité sur un <abbr title="Microcontrôleur Wi-Fi bon marché, très répandu chez les bricoleurs">ESP8266</abbr>, remontée dans <abbr title="Logiciel de domotique français, concurrent historique de Home Assistant">Jeedom</abbr>. Dix ans plus tard la maison compte 87 appareils sur neuf écosystèmes, 929 entités et 75 automatisations. Ce billet ouvre une série sur ce que l'IA change en domotique, vu depuis une installation réelle. Il pose l'inventaire, raconte comment on en arrive là un week-end à la fois, et mesure ce qui a bougé depuis que je travaille avec un agent. Deux exemples portent la différence. Deux enceintes <abbr title="Fabricant d'enceintes connectées, pilotables sur le réseau local">Sonos</abbr> livrées un mercredi, intégrées et câblées à treize annonces de routine le lendemain. Et un visiophone dont l'appel ne sortait par aucune intégration, récupéré via un pont maison de 225 lignes.</p></div>
<hr>
<p>Dix ans plus tard, on va reparler de domotique ici.</p>
<p>Le dernier billet sur le sujet date d'avril 2016. Un capteur de luminosité sur ESP8266, remonté dans Jeedom. Entre-temps il y a eu une maison de 1970, et une installation qui a grossi sans que j'en écrive une ligne.</p>
<p>Cette fois, le sujet n'est pas le montage. C'est ce que l'IA change dans ce domaine, vu depuis un cas précis, le mien. Pas un pilote d'entreprise, pas une démonstration de salon. Une maison de famille et dix ans d'habitudes de bricoleur.</p>

<h2>L'époque du fer à souder</h2>
<picture class="section-loop loop-light"><source media="(prefers-reduced-motion: reduce)" srcset="/visuals/ten-years-of-home-automation/solder-light.png"><img src="/visuals/ten-years-of-home-automation/solder-light.webp" alt="" width="240" height="120" loading="lazy" decoding="async"></picture>
<picture class="section-loop loop-dark"><source media="(prefers-reduced-motion: reduce)" srcset="/visuals/ten-years-of-home-automation/solder-dark.png"><img src="/visuals/ten-years-of-home-automation/solder-dark.webp" alt="" width="240" height="120" loading="lazy" decoding="async"></picture>
...
<p>Puis la maison a changé. Achat en 2019, rénovation d'une pièce par an jusqu'en 2025, et un déménagement de l'installation vers Home Assistant quelque part au milieu. Le matériel a suivi les travaux plutôt que l'inverse. Un module de volet quand la chambre a été refaite, une prise pilotée quand le salon a été ouvert, des thermomètres quand j'ai voulu comprendre pourquoi le bureau était invivable en août.</p>
...
<picture class="section-loop loop-light"><source media="(prefers-reduced-motion: reduce)" srcset="/visuals/ten-years-of-home-automation/inventory-light.png"><img src="/visuals/ten-years-of-home-automation/inventory-light.webp" alt="" width="240" height="120" loading="lazy" decoding="async"></picture>
<picture class="section-loop loop-dark"><source media="(prefers-reduced-motion: reduce)" srcset="/visuals/ten-years-of-home-automation/inventory-dark.png"><img src="/visuals/ten-years-of-home-automation/inventory-dark.webp" alt="" width="240" height="120" loading="lazy" decoding="async"></picture>
...
<picture class="section-loop loop-light"><source media="(prefers-reduced-motion: reduce)" srcset="/visuals/ten-years-of-home-automation/doorbell-light.png"><img src="/visuals/ten-years-of-home-automation/doorbell-light.webp" alt="" width="240" height="120" loading="lazy" decoding="async"></picture>
<picture class="section-loop loop-dark"><source media="(prefers-reduced-motion: reduce)" srcset="/visuals/ten-years-of-home-automation/doorbell-dark.png"><img src="/visuals/ten-years-of-home-automation/doorbell-dark.webp" alt="" width="240" height="120" loading="lazy" decoding="async"></picture>
...
<p>Entre « la sonnette ne remonte nulle part » et le pont en service, il s'est passé une soirée. L'agent a identifié le flux dans la documentation du constructeur, écrit le pont, câblé la découverte automatique et traité les cas d'erreur. J'ai fourni les identifiants de la platine et validé le résultat.</p>
...
<li><strong><a target="_blank" rel="noopener noreferrer" href="/posts/no-choices">La maison qui parle</a></strong> — concevoir treize annonces vocales pour des enfants, ce qui est un problème de rédaction avant d'être un problème technique.</li>
...
<ul>
<li><strong>Chaque couche a été posée pour une bonne raison.</strong> Aucune ne l'a été en pensant aux suivantes.</li>
...
const englishContent: PostContent = {
  ...
  html: `<div class="post-tldr"><p><strong>TL;DR</strong> My last home automation post here is dated April 2016: a light sensor on an <abbr title="A cheap Wi-Fi microcontroller, widely used by hobbyists">ESP8266</abbr>, reporting into <abbr title="French home automation software, a long-standing Home Assistant rival">Jeedom</abbr>. Ten years on, the house holds 87 devices across nine ecosystems, 929 entities and 75 automations. This post opens a series on what AI changes in home automation, seen from one real installation. It sets out the inventory, tells how you get there one weekend at a time, and measures what moved once I started working with an agent. Two examples carry the difference. Two <abbr title="Maker of networked speakers, controllable over the local network">Sonos</abbr> speakers delivered on a Wednesday, integrated and wired into thirteen routine announcements the next day. And a door entry panel whose call event reached no integration at all, recovered through a 225-line bridge written from scratch.</p></div>
<hr>
<p>Ten years on, we are going to talk about home automation here again.</p>
<p>The last post on the subject is dated April 2016. A light sensor on an ESP8266, reporting into Jeedom. In between there was a 1970s house, and an installation that grew without a single line written about it here.</p>
<p>This time the subject is not the build. It is what AI changes in this field, seen from one specific case, mine. Not an enterprise pilot, not a trade-show demo. A family house and ten years of hobbyist habits.</p>
...
<p>Then the house changed. Bought in 2019, one room renovated a year until 2025, with the installation moving to Home Assistant somewhere in the middle. Hardware followed the building work rather than the other way round. A shutter module when the bedroom was redone, a smart plug when the living room was opened up, thermometers when I wanted to know why the office was unlivable in August.</p>
...
<p>Between "the doorbell reaches nothing" and a working bridge, one evening passed. The agent identified the stream in the manufacturer's documentation, wrote the bridge, wired up auto-discovery and handled the error cases. I supplied the panel's credentials and checked the result.</p>
...
<li><strong><a target="_blank" rel="noopener noreferrer" href="/posts/no-choices">The house that speaks</a></strong> — designing thirteen spoken announcements for kids, which is a writing problem before it is a technical one.</li>
...
<ul>
<li><strong>Every layer was laid for a good reason.</strong> None of them was laid with the next one in mind.</li>
