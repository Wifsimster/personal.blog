...
<p>Ce premier épisode pose l'état des lieux. Ce qu'il y a dans la maison, comment ça s'est empilé, et ce que douze mois de travail avec un agent ont changé à un chantier que je menais seul.</p>
...
<p>This first episode sets out the state of things. What is in the house, how it piled up, and what twelve months of working with an agent changed about a project I had been running alone.</p>
